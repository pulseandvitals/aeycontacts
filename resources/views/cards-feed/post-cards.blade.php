...
<!---deletemodal--->
<div class="modal" id="modalcollab" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="hidden" id="collab_id"> 
        <p>Are you interested to apply in this collaboration?</p>
      </div>
      <div class="modal-footer">
        <button type="button" id="addcollab" class="btn btn-primary">Yes, I'm interested.</button>
