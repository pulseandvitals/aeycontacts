...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Job Feed</h1>
  ...
  <div class="spinner-border text-secondary" role="status">
    <span class="sr-only justify-text-center">Loading...</span>
  </div>
</div>
        ...
        $.ajax({
            ...
            $('.feedFetch').append('<div class="card border-dark">\
                ...
                <div class="card-body">\
                  ...
                  <button type="button" class="btn btn-primary btn-sm btn-collab" style="position: absolute; bottom:10px;right:10px;" id="applycollab" value="'+item.id+'"><i class="fa fa-plus tag"> Send resume </i></button>\
                 </div>\
                </div>');
              }
                else {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\aeycontacts\resources\views/Feed/index.blade.php ENDPATH**/ ?>