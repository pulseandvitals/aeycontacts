                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            >
                                <?php echo e(Auth::user()->status ? 'Active' : 'Inactive'); ?>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                        <span class="mr-2">
                            <i class="fas fa-circle text-success"></i> Job Seeker
                        </span>
                        <span class="mr-2">
                            <i class="fas fa-circle text-primary"></i> Employer
                        </span>
                        <span class="mr-2">
                            <i class="fas fa-circle text-info"></i> Guest
                        </span>
                    </div>
                </div>
            </div>
    ...
    $.ajax({
        ...
        success: function(e) {
            ...
            if(e.success){
                ...
                alert(e.message)
                window.location.href = e.routes.create;
            }
        }
    })
}
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\aeycontacts\resources\views/partials/dashboard.blade.php ENDPATH**/ ?>