<ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseReceipt" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="<?php echo e(url('/post-cards')); ?>">Post Cards</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="aw" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="<?php echo e(url('/api')); ?>">User API</a>
...
</ul><?php /**PATH C:\xampp7.0\htdocs\aeycontacts\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>